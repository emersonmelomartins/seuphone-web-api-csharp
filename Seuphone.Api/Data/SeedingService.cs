...
namespace Seuphone.Api.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Role r1 = new Role(new int(), "ROLE_ADMIN", "Administrador do Sistema");

            Role r2 = new Role(new int(), "ROLE_CLIENTE", "Cliente do Sistema");
            ...
            UserRole ur3 = new UserRole(u2, r2);
